...
export class ChatContextService {
    ...
    buildPrompt(input: {
        ...
        return [
            ...
            "Do not use italics.",
            "Do not use headings.",
            "Do not use decorative bullet symbols.",
            "Do not wrap words with ** or *.",
            "Keep the answer clear, direct, professional, and easy to read.",
            "Prefer short paragraphs over lists unless a list is truly necessary.",
            "",
